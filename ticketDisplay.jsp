...
<body>
    ...
    <div id="header" class="header">
        <div id="navbar" class="sticky">
            ...
            <a href="search.jsp"><img src="https://raw.githubusercontent.com/thehalfwedbride/Flight-WeBOP/master/PicsArt_08-18-10.22.33.png"
			...
			<div class="row">
				...
				<div class="col-8" style="text-align:center;">
					...
					<% 
						...
						out.println("PNR:"+t.getTicketId()+"<br>&nbsp;&nbsp;&nbsp;Date:"+t.getTicketDate().substring(0,11)+"<br>&nbsp;&nbsp;Passenger Name:"+t.getPassNames()+"<br>&nbsp;&nbsp;Status:"+t.getStatus()+"<br>");
